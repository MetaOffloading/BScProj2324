...
public class Q_VVIQ16 {
	public static void Run() {
		...
		VVIQ.item = "Finally, think of a country scene which involves trees, mountains and "
				+ "a lake. Consider the picture that comes before your mind's eye."
				+ " Now rate the following item:<br><br>"
				+ "<b>A strong wind blows on the trees and on the lake causing waves.</b>";
