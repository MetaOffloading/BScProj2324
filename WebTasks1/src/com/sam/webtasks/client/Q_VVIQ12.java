...
public class Q_VVIQ12 {
	public static void Run() {
		...
		VVIQ.item = "Think of the front of a shop to which you often go. Consider the picture that "
				+ "comes before your mind's eye. Now rate the following item:<br><br>"
				+ "<b>You enter the shop and go to the counter. The counter assistant "
				+ "serves you. Money changes hands.</b>";
