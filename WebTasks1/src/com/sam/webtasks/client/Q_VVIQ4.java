...
public class Q_VVIQ4 {
	public static void Run() {
		...
		VVIQ.item = "Think of some relative or friend whom you frequently see (but who "
				+ "is not with you at present) and consider carefully the picture that "
				+ "comes before your mind's eye. Now rate the following item:<br><br>"
				+ "<b>The different colours worn in some familiar clothes.</b>";
